...
class Settings(BaseSettings):
    """
    Defines a comprehensive set of configuration parameters for the Papyra library.

    This dataclass encapsulates various settings controlling core aspects of
    Papyra's behavior, including debugging modes, logging configuration,
    ...
    and potentially other debugging features within the Papyra system.
    Defaults to False.
    """

    version: str = __version__
    """
    Stores the current version string of the Papyra library.
