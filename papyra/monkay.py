...
def create_monkay(global_dict: dict) -> Monkay[None, Settings]:
    monkay: Monkay[None, Settings] = Monkay(
        ...
        lazy_imports={
            ...
            "ActorProxy": "papyra.proxy.ActorProxy",
            "ProxyAccessor": "papyra.proxy.ProxyAccessor",
            "ProxyCall": "papyra.messages.ProxyCall",
            "ProxyGetAttr": "papyra.messages.ProxyGetAttr",
            "ProxySetAttr": "papyra.messages.ProxySetAttr",
